...
const ACADEMY_LEVELS = [
  {
    id: 'worried', order: 1, name: 'Worried', emoji: '😟',
    accent: '#f0873a', accentSoft: '#ffe3c9',
    body: 'a fluttery tummy and a fast heartbeat',
    mind: '"what if" thoughts that race and repeat',
    tool: { icon: '🌬️', label: 'Three Slow Breaths', short: 'Breathe', desc: 'Breathe in slow, and out even slower.' },
  },
  {
    id: 'frustrated', order: 2, name: 'Frustrated', emoji: '😤',
    accent: '#e05a3c', accentSoft: '#ffd9cf',
    body: 'hot cheeks and tight, squeezed fists',
    mind: '"I can’t do this!" thoughts, loud and stuck',
    tool: { icon: '✋', label: 'Shake & Count to Five', short: 'Shake', desc: 'Shake out your hands, then count: one, two, three, four, five.' },
  },
  {
    id: 'excited', order: 3, name: 'Excited', emoji: '🤩',
    ...
    tool: { icon: '💃', label: 'Wiggle Dance', short: 'Wiggle', desc: 'Let the energy out with a big wiggle dance.' },
  },
  {
    id: 'sad', order: 4, name: 'Sad', emoji: '😢',
    accent: '#a3628f', accentSoft: '#ecd8e6',
    body: 'a heavy chest and drooping shoulders',
    mind: 'quiet, slow thoughts, not wanting to do much',
    tool: { icon: '🫂', label: 'Cozy Self-Hug', short: 'Hug', desc: 'Wrap your arms around yourself and name one warm thing you love.' },
  },
  {
    id: 'angry', order: 5, name: 'Angry', emoji: '😠',
    ...
    tool: { icon: '🦶', label: 'Stomp It Out', short: 'Stomp', desc: 'Stomp like a big dinosaur, then tell a grown-up what happened.' },
  },
  {
    id: 'scared', order: 6, name: 'Scared', emoji: '😨',
    accent: '#8a5c8a', accentSoft: '#e6d9e6',
    body: 'a racing heart and legs that freeze up',
    mind: '"what was that?!" thoughts that dart around',
    tool: { icon: '🧭', label: 'Brave Breath & Anchor', short: 'Anchor', desc: 'Take a slow brave breath, then find someone or something safe nearby.' },
  },
  {
    id: 'embarrassed', order: 7, name: 'Embarrassed', emoji: '😳',
    ...
    tool: { icon: '🤷', label: 'Shake It Off', short: 'Shrug', desc: 'A little shake, and remember: everyone messes up sometimes.' },
  },
  {
    id: 'proud', order: 8, name: 'Proud', emoji: '🥳',
    accent: '#e8a300', accentSoft: '#ffedb0',
    body: 'a warm chest and standing up nice and tall',
    mind: '"I did it!" thoughts, bright and loud',
    tool: { icon: '🙌', label: 'Proud Pose', short: 'Pose', desc: 'Arms up high, then share the moment with someone.' },
  },
  {
    id: 'overwhelmed', order: 9, name: 'Overwhelmed', emoji: '😵‍💫',
    accent: '#967f5c', accentSoft: '#e6ddc9',
    body: 'a tight, heavy body and a loud, foggy head',
    mind: '"too much, too much!" scattered thoughts',
    tool: { icon: '🤫', label: 'Quiet & One Thing', short: 'Quiet', desc: 'Step to somewhere quiet, then pick just one small thing to do.' },
  },
  {
    id: 'happy', order: 10, name: 'Happy', emoji: '😊',
    accent: '#f0b347', accentSoft: '#ffe8b0',
    body: 'light, bouncy steps and an easy smile',
    mind: '"today feels good" thoughts, warm and simple',
    tool: { icon: '😌', label: 'Pause & Savor', short: 'Savor', desc: 'Pause for a moment and really notice one good thing happening right now.' },
  },
];
